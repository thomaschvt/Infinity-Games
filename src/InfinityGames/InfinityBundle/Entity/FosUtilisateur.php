...
class FosUtilisateur
{
     ...
     * @var integer
     *
     * @ORM\Column(name="high_score", type="integer", nullable=false)
     */
    private $highScore;
     ...
     * @var integer
     *
     * @ORM\Column(name="nbr_creation", type="integer", nullable=false)
     */
    private $nbrCreation;
     ...
     * @var integer
     *
     * @ORM\Column(name="statut_developper", type="integer", nullable=false)
     */
    private $statutDevelopper;
    ...
    {
        $this->statutDevelopper = $statutDevelopper;
    
        return $this;
    }

    /**
     * Get statutDevelopper
     *
     * @return integer 
     */
    public function getStatutDevelopper()
    {
        return $this->statutDevelopper;
    }
